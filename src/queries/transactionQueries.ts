...
export const getUserTransactionsQuery = `SELECT t.amount, t.description, t.transaction_type, t.created_at, c.category_name FROM transactions t JOIN categories c ON t.category_id = c.id WHERE t.user_id = $1 ORDER BY t.created_at DESC`;
